          ...
          <div class="col-sm-12">
            <section class="panel">
              ...
              <table class="table">
                ...
                <thead>
                  <tr>
                    <form action="tabel-santri.php" method="get">
                ...
                <tbody>
                  ...
                  if(isset($_GET['cari'])){
                    $cari = $_GET['cari'];
                    $data = mysqli_query($con,"select * from santri where nik like '%".$cari."%'");       
                  }else{
                    $data = mysqli_query($con,"select * from santri order by nama");    
                  }
                  $no = 1;
