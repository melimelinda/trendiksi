                ...
                <div class="form">
                  <form class="form-validate form-horizontal" id="formperijinan" method="POST" action="saveijin.php">
                    ...
                    <div class="form-group ">
                      ...
                      <div class="col-lg-10">
                        <input class="form-control " id="tglizin" type="date" name="tglizin" data-date-format="dd-mm-yyyy" />
                      </div>
                    </div> -->
                    <div class="form-group ">
                      <label for="tglkembali" class="control-label col-lg-2">Tgl Kembali </label>
                      <div class="col-lg-10">
                        <input class="form-control" id="tglkembali" name="tglkembali" type="date" data-date-format="dd-mm-yyyy" required />
                      </div>
                    </div>
                    </div>
                    <div class="form-group">
